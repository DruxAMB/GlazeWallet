import { NATIVE_ETH_ADDRESS } from "./base-client";
...
export const CURATED_BASE_TOKENS: BaseToken[] = [
  { address: NATIVE_ETH_ADDRESS, symbol: "ETH", name: "Ethereum", decimals: 18, isNative: true },
  ...
  { address: "0x0b3e328455c4059EEb9e3f84b5543F74E24e7E1b", symbol: "VIRTUAL", name: "Virtuals Protocol", decimals: 18 },
  { address: "0x60a3E35Cc302bFA44Cb288Bc5a4F316Fdb1adb42", symbol: "EURC", name: "Euro Coin", decimals: 6 },
];

export const DEFAULT_FROM = NATIVE_ETH_ADDRESS;
export const DEFAULT_TO = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
